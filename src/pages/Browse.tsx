...
import { categories, languages, videoTypes } from '@/data/mockData';
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
          <div>
            ...
            {searchQuery && (
              <p className="text-muted-foreground mt-1">Search results for "{searchQuery}"</p>
            )}
          </div>
            ...
            {isLoading ? (
              ...
              <div className={cn(
                ...
                {filteredVideos.map((video) => (
                  <VideoCard key={video.id} video={video} variant={viewMode === 'list' ? 'horizontal' : 'default'} />
                ))}
              </div>
            )}
